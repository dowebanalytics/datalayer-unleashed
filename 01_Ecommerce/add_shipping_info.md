---
title: add_shipping_info — Selezione spedizione
type: note
tags:
  - ecommerce
  - datalayer
...
# add_shipping_info — Selezione spedizione

Push quando l'utente seleziona o conferma il metodo di spedizione durante il checkout.
...
window.dataLayer.push({
  ...
  ecommerce: {
    // Parametri chiave: currency, value, shipping_tier, items[]
  }
});
```
...
|-------------|---------|---------|
| GA4 | GA4 Event — add_shipping_info | Custom Event: `add_shipping_info` |
| Google Ads | Conversion Tracking | Custom Event: `add_shipping_info` |
| Meta Pixel / CAPI | Meta Pixel / CAPI tag | Custom Event: `add_shipping_info` |
...
- GA4 Event Reference: https://developers.google.com/analytics/devguides/collection/ga4/reference/events#add_shipping_info
